...
class Breadcrumbs
{
    ...
    public function __construct()
    {
        ...
        if ($framework == 'bootstrap') {
            ...
            $this->tags['olopen']   = "<ol class='breadcrumb breadcrumb-style2 mg-b-5'>";
            $this->tags['olclose']  = "</ol>";
            $this->tags['liopen']   = "<li class='breadcrumb-item'>";
            $this->tags['liclose']  = "</li>";
            $this->tags['liopenend']   = "<li class='breadcrumb-item active'>";
            $this->tags['licloseend']  = "</li>";
        }
    ...
    public function render()
    {
        ...
        foreach ($this->breadcrumbs as $index => $breadcrumb) {
            ...
            if ($index == $count) {
                $output .= $this->tags['liopenend'];
                //$output .= $breadcrumb['crumb'];
                $output .= '<span class="tx-12">' . $breadcrumb['crumb'];
                $output .= $this->tags['licloseend'];
            }
            // For all other breadcrumbs, include a link
                ...
                $output .= '<a class="tx-12" href="' . base_url($breadcrumb['href']) . '">';
                $output .= $breadcrumb['crumb'];
                $output .= '</a>';
